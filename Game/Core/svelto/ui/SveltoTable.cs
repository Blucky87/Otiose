...
{
    public class SveltoTable : SveltoGroup
    {
        ...
        List<SveltoCell> _cells = new List<SveltoCell>(4);
        SveltoCell _cellDefaults;
        List<SveltoCell> _columnDefaults = new List<SveltoCell>(2);
        SveltoCell _rowDefaults;
        ...
        SveltoValue _padTop = backgroundTop, _padLeft = backgroundLeft, _padBottom = backgroundBottom, _padRight = backgroundRight;
        int _align = SveltoAlign.AlignInternal.center;
        ...
        public SveltoTable()
        {
            ...
            transform = false;
            touchable = SveltoTouchable.ChildrenOnly;
        }


        SveltoCell obtainCell()
        {
            var cell = Pool<SveltoCell>.obtain();
            cell.setLayout(this);
            return cell;
        }
        ...
        public SveltoCell add(SveltoElement element)
        {
            var cell = obtainCell();
        ...
        public SveltoCell add(string text)
        {
        ...
        /// </summary>
        public SveltoCell add()
        {
            return add((SveltoElement)null);
        }
        ...
        public SveltoCell stack(params SveltoElement[] elements)
        {
            var stack = new Stack();
        ...
        public override bool removeElement(SveltoElement element)
        {
        ...
        public override void clearChildren()
        {
            ...
            if (_rowDefaults != null)
                Pool<SveltoCell>.free(_rowDefaults);
        ...
        public void reset()
        {
            ...
            _align = SveltoAlign.AlignInternal.center;
            ...
            for (int i = 0, n = _columnDefaults.Count; i < n; i++)
            {
                ...
                if (columnCell != null)
                    Pool<SveltoCell>.free(columnCell);
            }
        ...
        public SveltoCell row()
        {
            ...
            _rowDefaults = Pool<SveltoCell>.obtain();
            _rowDefaults.clear();
            return _rowDefaults;
        }
        ...
        public SveltoCell getColumnDefaults(int column)
        {
        ...
        public Table top()
        {
            _align |= SveltoAlign.AlignInternal.top;
            _align &= ~SveltoAlign.AlignInternal.bottom;
            return this;
        }
        ...
        public Table left()
        {
            _align |= SveltoAlign.AlignInternal.left;
            _align &= ~SveltoAlign.AlignInternal.right;
            return this;
        }
        ...
        {
            base.setDebug(true);
            if (_tableDebug != TableDebug.SveltoCell)
            {
                _tableDebug = TableDebug.SveltoCell;
                invalidate();
            }
            return this;
        }
        ...
        /// <summary>
        /// gets the current SveltoCell defaults. This is the same value returned by a call to row()
        /// </summary>
        /// <returns>The row defaults.</returns>
        public SveltoCell getRowDefaults()
        {
            if (_rowDefaults == null)
            {
                _rowDefaults = Pool<SveltoCell>.obtain();
        ...
        /// <param name="element">element.</param>
        public SveltoCell getCell(SveltoElement element)
        {
        ...
        public List<SveltoCell> getCells()
        {
            return _cells;
        }
        ...
        public override void layout()
        {
            ...
            for (int i = 0, n = children.Count; i < n; i++)
            {
                ...
                if (child is ISveltoLayout)
                    ((ISveltoLayout)child).validate();
            }
        }
        ...
        void layout(float layoutX, float layoutY, float layoutWidth, float layoutHeight)
        {
            ...
            else
            {
                ...
                columnWeightedWidth = SveltoTable._columnWeightedWidth = ensureSize(SveltoTable._columnWeightedWidth, columns);
            ...
            {
                rowWeightedHeight = SveltoTable._rowWeightedHeight = ensureSize(SveltoTable._rowWeightedHeight, rows);
            ...
            if ((_align & SveltoAlign.AlignInternal.right) != 0)
                x += layoutWidth - tableWidth;
            else if ((_align & SveltoAlign.AlignInternal.left) == 0) // Center
                x += (layoutWidth - tableWidth) / 2;

            var y = layoutY + padTop; // bottom
            if ((_align & SveltoAlign.AlignInternal.bottom) != 0)
                y += layoutHeight - tableHeight;
            else if ((_align & SveltoAlign.AlignInternal.top) == 0) // Center
            ...
            for (var i = 0; i < cellCount; i++)
            {
                ...
                if ((cellAlign & SveltoAlign.AlignInternal.left) != 0)
                    c.elementX = currentX;
                else if ((cellAlign & SveltoAlign.AlignInternal.right) != 0)
                    c.elementX = currentX + spannedCellWidth - c.elementWidth;
                else
                    c.elementX = currentX + (spannedCellWidth - c.elementWidth) / 2;

                if ((cellAlign & SveltoAlign.AlignInternal.top) != 0)
                    c.elementY = currentY + c.computedPadTop;
                else if ((cellAlign & SveltoAlign.AlignInternal.bottom) != 0)
        ...
        void computeDebugRects(float x, float y, float layoutX, float layoutY, float layoutWidth, float layoutHeight, float tableWidth, float tableHeight, float hpadding, float vpadding)
        {
            ...
            for (var i = 0; i < _cells.Count; i++)
            {
                ...
                if (_tableDebug == TableDebug.SveltoCell || _tableDebug == TableDebug.All)
                {
        ...
        static public SveltoValue backgroundTop = new BackgroundTopValue();

        /// <summary>
        /// Value that is the top padding of the table's background
        /// </summary>
        public class BackgroundTopValue : SveltoValue
        {
            public override float get(SveltoElement context)
            {
                var background = ((SveltoTable)context)._background;
                return background == null ? 0 : background.topHeight;
            }
        }


        static public SveltoValue backgroundLeft = new BackgroundLeftValue();

        /// <summary>
        /// Value that is the left padding of the table's background
        /// </summary>
        public class BackgroundLeftValue : SveltoValue
        {
            public override float get(SveltoElement context)
            {
                var background = ((SveltoTable)context)._background;
        ...
        static public SveltoValue backgroundBottom = new BackgroundBottomValue();

        /// <summary>
        /// Value that is the bottom padding of the table's background
        /// </summary>
        public class BackgroundBottomValue : SveltoValue
        {
            public override float get(SveltoElement context)
            {
                var background = ((SveltoTable)context)._background;
        ...
        static public SveltoValue backgroundRight = new BackgroundRightValue();

        /// <summary>
        /// Value that is the right padding of the table's background
        /// </summary>
        public class BackgroundRightValue : SveltoValue
        {
            public override float get(SveltoElement context)
            {
                var background = ((SveltoTable)context)._background;

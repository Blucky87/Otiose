...
{
    public class SveltoElement
    {
        protected SveltoStage stage;
        internal SveltoGroup parent;
        ...
        protected SveltoTouchable touchable = SveltoTouchable.Enabled;
        ...
        internal virtual void setStage(SveltoStage stage)
        {
            this.stage = stage;
        }
        ...
        internal void setParent(SveltoGroup parent)
        {
            this.parent = parent;
        }
        ...
        {
            return touchable == SveltoTouchable.Enabled;
        }


        public SveltoTouchable getTouchable()
        {
            return touchable;
        }
        ...
        public void setTouchable(SveltoTouchable touchable)
        {
        ...
        {
            float x = this.x;
            if ((alignment & SveltoAlign.AlignInternal.right) != 0)
                x += width;
            else if ((alignment & SveltoAlign.AlignInternal.left) == 0)
                x += width / 2;
            return x;
        }


        public SveltoElement setX(float x)
        {
            if (this.x != x)
            {
                this.x = x;
        ...
        {
            float y = this.y;
            if ((alignment & SveltoAlign.AlignInternal.bottom) != 0)
                y += height;
            else if ((alignment & SveltoAlign.AlignInternal.top) == 0)
                y += height / 2;
            return y;
        }


        public SveltoElement setY(float y)
        {
            if (this.y != y)
            {
                this.y = y;
        ...
        public SveltoElement setPosition(float x, float y)
        {
        ...
        public void setPosition(float x, float y, int alignment)
        {
            ...
            if ((alignment & SveltoAlign.AlignInternal.top) != 0)
                y -= height;
            else if ((alignment & SveltoAlign.AlignInternal.bottom) == 0) //
                y -= height / 2;
        ...
        {
            if ((alignment & SveltoAlign.AlignInternal.left) != 0)
                originX = 0;
            else if ((alignment & SveltoAlign.AlignInternal.right) != 0)
                originX = width;
            else
                originX = width / 2;
        ...
        /// <param name="localCoords">Local coords.</param>
        public Vector2 localToAscendantCoordinates(SveltoElement ascendant, Vector2 localCoords)
        {
            SveltoElement element = this;
            while (element != null)
            {
        ...
        public virtual SveltoElement hit(Vector2 point)
        {
            // if we are not Touchable or us or any parent is not visible bail out
            if (touchable != SveltoTouchable.Enabled || !areParentsVisible())
                return null;
        ...
        public virtual void invalidateHierarchy()
        {
            ...
            if (parent is ISveltoLayout)
                ((ISveltoLayout)parent).invalidateHierarchy();
        }
